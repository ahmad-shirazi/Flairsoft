...
# batch size shows how many pages should be grouped into each json output file.
def async_detect_document(gcs_source_uri, gcs_destination_uri, mime_type=google_config["pdf"], batch_size=1000):
